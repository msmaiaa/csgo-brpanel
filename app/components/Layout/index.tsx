  ...
  return (
    <div
      style={{
        ...
        width: "100%",
        alignItems: "center",
        backgroundColor: theme.data.backgroundSecondary,
      }}
    >
      <ProSidebar style={{ height: "100%" }}>
        ...
        >
          ...
          >
            <MenuItem
              ...
              icon={
                <FontAwesomeIcon className={styles.menu_icon} icon={faHome} />
              }
            >
              <Link href="/">
                <p className={styles.menulink}>Início</p>
              </Link>
            </MenuItem>
            {user ? (
              <>
                ...
                >
                  <Link href="/store">
                    <p className={styles.menulink}>Loja</p>
                  </Link>
                </MenuItem>
                {user.user_type > 0 && (
                  <SubMenu
                  ...
                  >
                    <MenuItem
                      className={`${classes.menu_item} ${classes.sub_menu_item}`}
                    >
                      <Link href="/manageusers">
                        <p className={styles.menulink}>Usuários</p>
                      </Link>
                    </MenuItem>
                    <MenuItem
                      className={`${classes.menu_item} ${classes.sub_menu_item}`}
                    >
                      <Link href="/managecargos">
                        <p className={styles.menulink}>Cargos</p>
                      </Link>
                    </MenuItem>
                    <MenuItem
                      className={`${classes.menu_item} ${classes.sub_menu_item}`}
                    >
                      <Link href="/manageservers">
                        <p className={styles.menulink}>Servidores</p>
                      </Link>
                    </MenuItem>
                  </SubMenu>
                )}
                {user.user_type == 2 && (
                  <>
                    ...
                    >
                      <Link href="/salesrecord">
                        <p className={styles.menulink}>Histórico de vendas</p>
                      </Link>
                    </MenuItem>
                    <MenuItem
                      className={classes.menu_item}
                    ...
                    >
                      <Link href="/logs">
                        <p className={styles.menulink}>Logs</p>
                      </Link>
                    </MenuItem>
                  </>
                )}
        ...
        <SidebarFooter>
          {newTheme && (
            ...
            >
              <p style={{ marginRight: "15px", color: theme.data.textColor }}>
                Tema:{" "}
              </p>
              <FormControl
                style={{
              ...
              >
                ...
                >
                  <MenuItem className={classes.menuitem} value="light">
                    Claro
                  </MenuItem>
                  <MenuItem className={classes.menuitem} value="dark">
                    Escuro
                  </MenuItem>
                </Select>
              </FormControl>
