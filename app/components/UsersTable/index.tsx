...
const UsersTable = ({ onEditClick, updateData, setUpdateData }: Props) => {
          ...
          <Table size="small">
            <TableHead>
              <TableRow className={classes.table_row}>
                ...
                <TableCell align="left" className={styles.tableHeadText}>
                  SteamID
                </TableCell>
                <TableCell align="left" className={styles.tableHeadText}>
                  Autorização
                </TableCell>
                <TableCell align="center" className={styles.tableHeadText}>
                  Cargos
                </TableCell>
                <TableCell align="center" className={styles.tableHeadText}>
                  Data de cadastro
            ...
            <TableBody>
              {rows.map((row) => (
                <TableRow key={row.id} className={classes.table_row}>
                  ...
                  <TableCell align="left" className={styles.tableBodyText}>
                    {userTypeFromNumber(row.user_type)}
                  </TableCell>
                  <TableCell align="center" className={styles.tableBodyText}>
                    {row.user_cargo ? row.user_cargo.length : 0}
                  </TableCell>
                  <TableCell align="center" className={styles.tableBodyText}>
