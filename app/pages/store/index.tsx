      ...
      <Layout user={props.user}>
        ...
        >
          <div className={styles.cargos_container}>
            ...
            <div
              className={styles.cargosContent}
              style={{
                      ...
                      {cargosAllServers.length > 0 &&
                        serversWithCargo.length > 0 && (
                          <MenuItem
                            ...
                            value={cargosAllServers}
                          >
                            Cargo em todos os servidores
                          </MenuItem>
                        )}
                    ...
                    return (
                      ...
                      >
                        <div>
                          ...
                          <p className={styles.cargo__duration}>
                            {cargo.duration} dias
                          </p>
                          <p
                            className={styles.cargo__pricetext}
                            style={{ marginLeft: "20px" }}
                          >
                            R$
                            <span className={styles.cargo__price}>
                              {cargo.price},00
                            </span>
                          </p>
                        </div>
                        <div className={styles.cargo__footer}>
                          <Image
                            ...
                            height="25"
                            alt="pagseguro_btn"
                            onClick={() => handleBuy(cargo, "pagseguro")}
